...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    /**
     * @var \Goretail\ExtraPromotion\Model\Rule\Condition\Address
     */
     ...
     * @param \Goretail\ExtraPromotion\Model\Rule\Condition\Address $conditionAddress
     * @param array $data
     */
    public function __construct(
        \Magento\Rule\Model\Condition\Context $context,
        \Magento\Framework\Event\ManagerInterface $eventManager,
        \Goretail\ExtraPromotion\Model\Rule\Condition\Address $conditionAddress,
        array $data = []
    ) {
        $this->_eventManager = $eventManager;
        $this->_conditionAddress = $conditionAddress;
        parent::__construct($context, $data);
        $this->setType(\Goretail\ExtraPromotion\Model\Rule\Condition\Combine::class);
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        foreach ($addressAttributes as $code => $label) {
            $attributes[] = [
                'value' => 'Goretail\ExtraPromotion\Model\Rule\Condition\Address|' . $code,
                'label' => $label,
            ];
        }
